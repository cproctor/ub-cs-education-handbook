...
## LAI 676: The Pedagogy of Programming {#lai-676}
...
[CK1](#ck1 "Impacts of computing"){.outcome .ck} [CK2](#ck2 "Computational thinking"){.outcome .ck} [PCK2](#pck2 "Supporting learner identities"){.outcome .pck} [PCK4](#pck4 "Teaching with computational media"){.outcome .pck} [PCK5](#pck5 "Feedback and assessment"){.outcome .pck} [L2](#l2 "Connected learning"){.outcome .l}
