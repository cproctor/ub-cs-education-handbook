...
[PK3](#pk3 "Supporting students with disabilities"){.outcome .pk} [PK4](#pk4 "Language acquisition and literacy"){.outcome .pk} [PCK3](#pck3 "Shaping the learning environment"){.outcome .pck} [PCK4](#pck4 "Teaching with computational media"){.outcome .pck} [PCK5](#pck5 "Feedback and assessment"){.outcome .pck}
